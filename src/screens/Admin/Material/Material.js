...
const Material = ({ navigation }) => {
    ...
    return (
        ...
        >
            ...
            <FlatList data={materials} renderItem={({ item }) => <ItemMaterial item={item} callback={fetchMaterialType} navigation={navigation} />} keyExtractor={(item, index) => index.toString()} />
        </SafeAreaView>
    )
}
