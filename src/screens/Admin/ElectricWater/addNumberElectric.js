...
import { doAddNumberElectric } from '../../../redux/actions/room';
...
class AddNumberElectric extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: true,
    ...
    AddNumberElectric(values) {
        this.props.doAddNumberElectric(values).then(data => {
            if(data){
                alert("Thêm số điện thành công!");
                this.props.navigation.goBack(null);
            }else{
                alert("Thêm số điện không thành công! Vui lòng thử lại!")
            }
        })
    }
...
const mapDispatchToProps = {
    doAddNumberElectric, doGetListArea, doGetRoomByArea
};

export default connect(mapStateToProps, mapDispatchToProps)(AddNumberElectric)