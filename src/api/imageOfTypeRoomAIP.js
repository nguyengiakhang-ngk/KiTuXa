...
import {ADD_IMAGE_TYPE_ROOM, DELETE_IMAGE_TYPE_ROOM} from '../constant/apiUrl'
...
export const deleteImageTypeOfRoom = async (imageTypeOfRoom) => {
    return doDelete(DELETE_IMAGE_TYPE_ROOM, imageTypeOfRoom);
}
